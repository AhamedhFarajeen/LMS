  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        <div className="absolute top-0 left-0 w-full h-125  bg-linear-to-b from-cyan-100/70"></div>

        {/* left column */}
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-['36px', '44px'] text-3xl font-bold leading-tight text-gray-800">
          ...
          <p className="text-sm">
            Course by <span className="text-blue-600 underline">afbaf</span>
          </p>
        ...
        <div className="max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0, 0, 0, 0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="flex gap-3 items-center pt2">
